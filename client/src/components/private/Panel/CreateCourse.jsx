              ...
              <div className="field-body">
                <div className="field">
                  <div className="control icons-left">
                    <input className="input" name={CreateCourseKeys.CourseName} onChange={onChange} type="text"
                      placeholder="Course name" value={values[CreateCourseKeys.CourseName]} />
                ...
                <div className="field">
                  ...
                  <div className="control icons-left">
                    <input className="input" name={CreateCourseKeys.CourseCategory} onChange={onChange} type="text"
                      placeholder="Course category" value={values[CreateCourseKeys.CourseCategory]} />
                ...
                <div className="field">
                  ...
                  <div className="control icons-left">
                    <input className="input" type="number" name={CreateCourseKeys.CoursePrice} onChange={onChange}
                      placeholder="Course price" value={values[CreateCourseKeys.CoursePrice]} />
                ...
                <div className="field">
                  ...
                  <div className="control icons-left">
                    <input className="input" type="text" name={CreateCourseKeys.CourseDifficulity} onChange={onChange}
                      placeholder="Course difficulity" value={values[CreateCourseKeys.CourseDifficulity]} />
                ...
                <div className="field">
                  ...
                  <div className="control icons-left">
                    <input className="input" type="text" name={CreateCourseKeys.InstructorName} onChange={onChange}
                      placeholder="Instructor name" value={values[CreateCourseKeys.InstructorName]} />
                ...
                <div className="field">
                  ...
                  <div className="control icons-left">
                    <input className="input" type="text" name={CreateCourseKeys.CourseImage} onChange={onChange}
                      placeholder="Course Image" value={values[CreateCourseKeys.CourseImage]} />
                ...
                <div className="field">
                  ...
                  <div className="control">
                    <textarea className="textarea" name={CreateCourseKeys.CourseDescription} onChange={onChange}
                      placeholder="Enter course description"
                      value={values[CreateCourseKeys.CourseDescription]}></textarea>
                  </div>
