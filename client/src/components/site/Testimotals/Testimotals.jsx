            ...
            <div className="owl-carousel testimonial-carousel">
              <div className="bg-white p-5">
                ...
                <div className="d-flex flex-shrink-0 align-items-center mt-4">
                  <img className="img-fluid mr-4" src="img/testimonial-2.jpg" alt="" style={{ maxWidth: '100%', height: 'auto' }} />
                  <div>
                    <h5>Student Name</h5>
              ...
              <div className="bg-white p-5">
                ...
                <p>Sed et elitr ipsum labore dolor diam, ipsum duo vero sed sit est est ipsum eos clita est ipsum. Est nonumy tempor at kasd. Sed at dolor duo ut dolor, et justo erat dolor magna sed stet amet elitr duo lorem</p>
                <div className="d-flex flex-shrink-0 align-items-center mt-4">
                  <img className="img-fluid mr-4" src="img/testimonial-1.jpg" alt="" style={{ maxWidth: '100%', height: 'auto' }} />
                  <div>
                    <h5>Student Name</h5>
                    <span>Web Design</span>
                  </div>
...
const EnhancedTestimonials = withCarousel(Testimonials, '.testimonial-carousel');
